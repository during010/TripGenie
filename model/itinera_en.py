...
from model.utils.all_en_prompts import get_start_point_prompt, get_dayplan_prompt, get_system_prompt, get_hour_prompt, check_final_reverse_prompt, process_input_prompt
...
class ItiNera:
    ...
    def solve(self):
        ...
        time = self.hours
        print(f'Itinerary: \n{full_response_data}')
        return full_response_data, lookup_dict, path, time,0,0